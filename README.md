...
3. Create a PostgreSQL database, there's a script in root folder to create the database and the tables (alternarively you can use the Prisma Studio to create the database and tables based on the schema)
